...
<el-form-item label="讲师头像">
    ...
    <image-cropper
                   ...
                   :height="300"
                   :key="imagecropperKey"
                   :url="BASE_API+'/eduoss/fileoss/loadFile'"
                   field="file"
                   @close="close"
    ...
    data() {
        ...
        return {
            teacher: {
                ...
                career: '',
                intro: '',
                avatar:'https://edu-2000.oss-cn-shenzhen.aliyuncs.com/2020/04/28/36a32a553d8348d28d4073d5f40e63b3file.png',
            },
       ...
       cropSuccess(data){
        ...
        getTeacherById(id){
            teacherApi.getTeacherById(id)
                .then(response =>{
                  this.teacher =  response.data.teacherid
                })
